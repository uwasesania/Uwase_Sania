...
while ($row=mysqli_fetch_assoc($fetch)) {
    ...
    <td class='p-2'><a href='update.php?pId=".$row['pId']."' class='btn btn-primary'>Update</a></td>
    <td class='p-2'><a href='delete.php?pId=".$row['pId']."' class='btn btn-primary'>Delete</a></td>
</tr>
    ";
}
?>
