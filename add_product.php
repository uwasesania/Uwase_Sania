...
if (isset($_POST['add'])) {
    ...
    $add=$conn->query("INSERT INTO stock(productname,quantity,date,price) VALUES('$pname','$quantity','$date','$price')");
    if ($add) {
  ...
  <li class="nav-item">
    ...
    <table class="table table-hover m-5 w-50 mx-auto bg-white shadow ">
        ...
        <tr>
            ...
            <td><input type="text" class="form-control" name="price"required placeholder="RWF"></td>
