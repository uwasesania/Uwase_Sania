...
<div class="header container-fluid w-100 shadow bg-white" >
    ...
    <div class="container">
        <div class="card mx-auto w-30 mt-5 shadow p-5 h-100 bg-white " id="card">
           <form  class="form" method="post">
            ...
            <div class="mt-3" >
                ...
                <label for="checkbox" class="form-check-label">
                    <input type="checkbox" name="checkbox" class="form-check-input border-success">
                    Remember me
                </label><br>
                <p><center><button type="submit" class="btn btn-primary col-6" name="submit" >Login</button></center></p>
                <p>CREAT ACCOUNT <a href="register.php">register</a></p>
            </div>
           </form>
        </div>
